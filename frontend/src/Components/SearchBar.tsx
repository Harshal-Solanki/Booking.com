    ...
    return(
        <form onSubmit={handleSubmit} className=" p-2 bg-orange-400 rounded shadow-md grid grid-cols-2 lg:grid-cols-3 2xl:grid-cols-5 items-center gap-3 ">
            ...
            <div className="flex gap-1">
              <button className="w-2/3 bg-blue-600 text-white h-full p-2 font-bold text-x1 hover:bg-blue-800">
                Search
              </button>
              <button className="w-1/3 bg-red-600 text-white h-full p-2 font-bold text-x1 hover:bg-red-700">
                Clear
              </button>
            </div>
        </form>
