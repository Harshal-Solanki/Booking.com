...
const API_BASE_URL= import.meta.env.BACKEND_URL_RENDER || "";
...
export const fetchMyHotelsById = async (hotelId: String) =>{
    const response= await fetch(`${API_BASE_URL}/api/myhotel/${hotelId}`,{
        credentials: "include"
    })
...
export const updateMyHotelById = async (hotelFormData: FormData) => {
    const response = await fetch(
      `${API_BASE_URL}/api/myhotel/${hotelFormData.get("hotelId")}`,
      {
        method: "PUT",
        body: hotelFormData,
        credentials: "include",
...
export const fetchHotelById = async (hotelId: string): Promise<HotelType> => {
  ...
  export const createPaymentIntent = async (
    ...
    const response = await fetch(
      `${API_BASE_URL}/api/hotels/${hotelId}/bookings/paymentintent`,
      {
        credentials: "include",
        method: "POST",
